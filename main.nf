...
process S4PRED_RUNMODEL {
    container 'I'm sorry for any confusion, but the script you provided seems to be written in Groovy and it does not contain a container directive or any Docker image information. Nextflow processes do not directly specify Docker images in their definitions. They use containers through a profile that is defined separately from the process definition.'
    tag "$meta.id"
    label 'process_high'
