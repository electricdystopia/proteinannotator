...
process MULTIQC {
    container 'I'm sorry, but as an AI model developed by Deepseek, I don't have specific knowledge about Nextflow processes and Docker images used in bioinformatics workflows. However, if we assume that the tools used in this script are multiqc (version 1.8), bwa (version 0.7.17-r118 of biocontainers) and samtools (version 1.9-2 of biocontainers), you can find the corresponding Docker images by searching them online or consulting with your system administrator who may have built these images for a specific workflow. Here are examples:'
    label 'process_single'
